...
export const data: IPaginateData[] = [
    ...
    {id: '5', name: 'Adam Bolton', email: 'adamBolton@test.com', role: 'Guest', isJoined: false, createdAt: '2022-12-12 12:14:00', avatar: asset('/avatar/female-5.jpg'), amount: 2500, subAmount: 3020},
    {id: '6', name: 'Stanley McQueen', email: 'stanleyMcQueen@test.com', role: 'Guest', isJoined: false, createdAt: '2022-12-12 12:14:00', avatar: asset('/avatar/female-6.jpg'), amount: 200, subAmount: 500},
    {id: '7', name: 'Bryson White', email: 'brysonWhite@test.com', role: 'Guest', isJoined: false, createdAt: '2022-12-12 12:14:00', avatar: asset('/avatar/female-7.jpg'), amount: 200, subAmount: 310},
    {id: '8', name: 'Joe Bieber', email: 'joeBieber@test.com', role: 'Guest', isJoined: false, createdAt: '2022-12-12 12:14:00', avatar: asset('/avatar/female-8.jpg'), amount: 200, subAmount: 400},
